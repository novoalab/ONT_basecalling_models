...
human_filt %>% 
  ...
  ggplot(aes(x = reorder(mod_simplified, -wt), y = wt, fill = mod_simplified)) + 
...
ggsave(
  filename = here::here("..", "__results_Gregor", "rRNA", "wt_vs_ivt", "pseU", "boxplots_wt_amounts", "human_28s_18s_simplified.pdf"),
  plot = last_plot(),
  device = "pdf",
  width = 6,
  height = 8,
