...
write.table(master_tbl, file= here("..","__results_Gregor","rRNA","tables","master_table_filtered_m5C.tsv"), sep = "\t", row.names = F)
...
ggsave(filename = here("..","__results_Gregor","rRNA","wt_vs_ivt", "m5C","boxplots_wt_amounts","ecoli_23S_16S_rep1_mods_simplified.pdf"),       
       plot = last_plot(), 
       device = "pdf", 
       width = 6, height = 6, units = "in")
...
ggsave(filename = here("..","__results_Gregor","rRNA","wt_vs_ivt", "m5C","stacked_barchart","all_species_wt+ivt_filtered_rep1_simplified.pdf"),       
       plot = last_plot(), 
       device = "pdf", 
